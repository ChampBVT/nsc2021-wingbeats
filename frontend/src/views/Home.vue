  ...
  <div class="home">
    ...
    <div>
      <b-card class="card"
        ...
        img-src="https://miro.medium.com/max/640/1*B59shuZs0Wubfoedd4hdQw.png"
        img-alt="upload logo"
        img-top
        >
      <b-form-file
...
export default {
  ...
  data() {
    ...
    items: [
      { isActive: true, file_name: 'Mosquitoes_1', date: '21/06/2019', time: '9.09 AM', length: '11 seconds', result: 'More details' },
      { isActive: true, file_name: 'Mosquitoes_2', date: '17/06/2019', time: '10.34 AM', length: '45 seconds', result: 'More details' },
      { isActive: true, file_name: 'Mosquitoes_3', date: '08/06/2019', time: '6.12 PM', length: '2 seconds', result: 'More details' },
      { isActive: true, file_name: 'Mosquitoes_4', date: '13/05/2019', time: '11.55 PM', length: '37 seconds', result: 'More details' }
    ]
    };
  },
  mounted() {},
